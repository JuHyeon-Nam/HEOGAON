...
const paths: Record<IconName, string> = {
  ...
  check: '<path d="M20 6 9 17l-5-5" stroke="currentColor" stroke-width="2.8" stroke-linecap="round" stroke-linejoin="round"/>',
  ...
  fileCheck: '<path d="M9 3h6l2 2h3v16H4V5h3l2-2z" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 14l2 2 4-5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',
  ...
  message: '<path d="M21 11.5a7.5 7.5 0 0 1-7.5 7.5H8l-5 3 1.4-4.3A7.5 7.5 0 1 1 21 11.5z" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 10h8M8 14h5" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/>',
  monitor: '<circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="2"/><path d="M3 12h18M12 3c2.3 2.4 3.5 5.4 3.5 9s-1.2 6.6-3.5 9M12 3c-2.3 2.4-3.5 5.4-3.5 9s1.2 6.6 3.5 9" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>',
  ...
  search: '<path d="M10.5 18a7.5 7.5 0 1 1 5.3-2.2L21 21" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 10.5h5M10.5 8v5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>',
  signpost: '<path d="M12 21V4M5 5h11l3 3-3 3H5V5zM19 13H8l-3 3 3 3h11v-6z" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/>',
  store: '<path d="M4 10h16l-1.2-4.8A1.6 1.6 0 0 0 17.3 4H6.7a1.6 1.6 0 0 0-1.5 1.2L4 10z" stroke="currentColor" stroke-width="1.9" stroke-linejoin="round"/><path d="M5 10v10h14V10M9 20v-5h6v5M4 10c0 1.2 1 2.2 2.2 2.2S8.4 11.2 8.4 10c0 1.2 1 2.2 2.2 2.2s2.2-1 2.2-2.2c0 1.2 1 2.2 2.2 2.2s2.2-1 2.2-2.2c0 1.2 1 2.2 2.2 2.2S20 11.2 20 10" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/>',
